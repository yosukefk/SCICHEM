...
INTEGER FUNCTION DtmsExtendedZone8( lon,lat,izone,xdecal,xeast,xnorth,idir, &
                                    ierr,lipsoid) RESULT( irv )

!DEC$ ATTRIBUTES STDCALL, DECORATE, ALIAS : 'DtmsExtendedZone8' :: DtmsExtendedZone8
!DEC$ ATTRIBUTES DLLEXPORT::DtmsExtendedZone8
!DEC$ ATTRIBUTES REFERENCE :: lon
!DEC$ ATTRIBUTES REFERENCE :: lat
!DEC$ ATTRIBUTES REFERENCE :: izone
!DEC$ ATTRIBUTES REFERENCE :: xdecal
...
IF( idir > 0 )THEN
  ...
  CALL drgput8( lon,lat,izone,xeast,xnorth )

ELSE IF( idir < 0 )THEN

  CALL drutgp8( xeast,xnorth,izone,lon,lat )
...
!************************************************************************
       SUBROUTINE drgput8( lon,lat,izone,xeast,xnorth )
!**********************************************************************
...
INTEGER, INTENT( INOUT ) :: izone
REAL(8), INTENT( OUT   ) :: xeast, xnorth
...
!************************************************************************
       SUBROUTINE drutgp8( xeast,xnorth,izone,lon,lat )
!**********************************************************************
