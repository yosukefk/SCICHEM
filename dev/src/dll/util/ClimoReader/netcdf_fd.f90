...
!DEC$ ATTRIBUTES C, ALIAS:'nc_get_vara_text' :: nc_get_vara_text
!DEC$ ATTRIBUTES VALUE     :: fid, varid
!DEC$ ATTRIBUTES REFERENCE :: istart, icount
!DEC$ ATTRIBUTES REFERENCE :: string
    USE basic_fd
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_create' :: nc_create
!DEC$ ATTRIBUTES REFERENCE :: fname
!DEC$ ATTRIBUTES VALUE     :: omode
!DEC$ ATTRIBUTES REFERENCE :: fid
    CHARACTER(*), INTENT( IN )  :: fname
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_def_dim' :: nc_def_dim
!DEC$ ATTRIBUTES VALUE     :: fid
!DEC$ ATTRIBUTES REFERENCE :: dimname
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_def_var' :: nc_def_var
!DEC$ ATTRIBUTES VALUE     :: fid
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_redef' :: nc_redef
!DEC$ ATTRIBUTES VALUE :: fid
    INTEGER, INTENT( IN ) :: fid
  END FUNCTION nc_redef

  INTEGER FUNCTION nc_enddef( fid )
!DEC$ ATTRIBUTES C, ALIAS:'nc_enddef' :: nc_enddef
!DEC$ ATTRIBUTES VALUE :: fid
    INTEGER, INTENT( IN ) :: fid
  END FUNCTION nc_enddef

  INTEGER FUNCTION nc_put_vara_int( fid,varid,istart,icount,array )
!DEC$ ATTRIBUTES C, ALIAS:'nc_put_vara_int' :: nc_put_vara_int
!DEC$ ATTRIBUTES VALUE     :: fid, varid
!DEC$ ATTRIBUTES REFERENCE :: istart, icount
!DEC$ ATTRIBUTES REFERENCE :: array
    USE basic_fd
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_put_vara_float' :: nc_put_vara_float
!DEC$ ATTRIBUTES VALUE     :: fid, varid
!DEC$ ATTRIBUTES REFERENCE :: istart, icount
!DEC$ ATTRIBUTES REFERENCE :: array
    USE basic_fd
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_put_vara_double' :: nc_put_vara_double
!DEC$ ATTRIBUTES VALUE     :: fid, varid
!DEC$ ATTRIBUTES REFERENCE :: istart, icount
!DEC$ ATTRIBUTES REFERENCE :: array
    USE basic_fd
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_put_att_text' :: nc_put_att_text
!DEC$ ATTRIBUTES VALUE     :: fid, varid
!DEC$ ATTRIBUTES REFERENCE :: attname
...
!DEC$ ATTRIBUTES C, ALIAS:'nc_inq_dimlen' :: nc_inq_dimlen
!DEC$ ATTRIBUTES VALUE     :: fid, dimid
