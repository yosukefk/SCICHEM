...
#$(info $$INCMOD is [${INCMOD}])

SRCS_f90 = bin/SciDOSpost/sciDOSpost.f90 bin/SciDOSpost/getAllFieldValues.f90 \
	  bin/SciDOSpost/mod_sciDOSpost_tools.f90 bin/SciDOSpost/mod_netcdf_tools.f90 \
	  bin/SciDOSpost/mod_time_tools.f90 \
...
DIRS = bin/PostProcess bin/SciDOSpost dll/util/ClimoReader
...
bin/SciDOSpost/mod_time_tools.o:$(BD)/bin/SciDOSpost/mod_time_tools.f90 $(INCMOD)

bin/SciDOSpost/mod_netcdf_tools.o:$(BD)/bin/SciDOSpost/mod_netcdf_tools.f90 dll/util/ClimoReader/netcdf_fd.o $(INCMOD)

bin/SciDOSpost/mod_sciDOSpost_tools.o:$(BD)/bin/SciDOSpost/mod_sciDOSpost_tools.f90  \
	  bin/SciDOSpost/mod_time_tools.o bin/SciDOSpost/mod_netcdf_tools.o\
	  ...
	  lib/SCIPUFFlib/SCIMgr/inc/tooluser_fd.o dll/util/ClimoReader/netcdf_fd.o $(INCMOD)
