...
!------ Properties of Air & Atmosphere
  ...
  REAL, PARAMETER :: MR      = 0.62198       !MW_WATER / MWAIR (WMO value for rel. humid.)
  ...
  REAL, PARAMETER :: PPM2UGM3  = &
                     PSURF*750.06/(62.4*298) !Factor for converting ppm to ug/m3 using EPA STP values
